...
(function(w) {
  var s = {
    ...
    AccessibilityEmptyVizInstructions: "No data to visualise with current filters. To create a visualisation and access the View Data Window, expand filters.",
    AccessibilityEnabledViewDataDisabled: "Press Enter to navigate through the marks on the visualisation.",
    ...
    AccessibilityViewDataInstructions: "Press Enter to navigate through the marks on the visualisation, or press Shift+Enter to open the View Data window and navigate the marks in a table.",
    AccessibilityVizInTooltipsUnreadable: "There is an unreadable viz.",
    AccessibilityVizLevelNavigationScreenReaderText: "Use arrow keys to navigate data visualisation elements.",
    ...
    ShowPageErrorResourceLimitExceededDetail: "Computing the current visualisation has exceeded the resource limit",
